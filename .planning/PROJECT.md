...
用户能真实体验 AI 虚拟试衣并获得精准的个性化穿搭推荐，这是产品体验闭环的核心。
...
- **ML 策略**: 文生图和图生图的多模态模型策略，非传统 CatVTON 单一方案
- **AI 集成**: GLM API（智谱）+ 本地推理服务混合模式
...
| 文生图/图生图多模态策略 | 灵活性高于单一 CatVTON 方案 | — Pending |
| Zustand + TanStack Query | 服务端状态和 UI 状态分离 | ✓ Good |
| GLM API + 本地推理混合 | 平衡成本和能力 | — Pending |
