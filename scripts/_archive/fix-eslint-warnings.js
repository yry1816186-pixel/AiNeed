...
try {
  execSync(
    'node C:/AiNeed/node_modules/eslint/bin/eslint.js "{src,test}/**/*.ts" -f json -o ' +
      eslintJsonPath,
...
for (const [filePath, warnings] of Object.entries(fileWarnings)) {
  ...
  for (const warning of sortedWarnings) {
    ...
    const isUnusedArrayElement = warning.message.includes(
      "Allowed unused elements of array destructuring must match"
    );
