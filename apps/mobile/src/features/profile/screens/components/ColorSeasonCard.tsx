...
const COLOR_MAP: Record<string, any> = {
  ...
  芥末黄: DesignTokens.colors.fashion.mustard,
  南瓜色: DesignTokens.colors.fashion.pumpkin,
  酒红色: DesignTokens.colors.fashion.burgundy,
  正红色: "colors.error",
  纯白色: colors.surface,
  黑色: DesignTokens.colors.neutral.black,
  宝蓝色: DesignTokens.colors.fashion.royalBlue,
  翠绿色: DesignTokens.colors.fashion.emerald,
  ...
  淡粉色: DesignTokens.colors.fashion.lightPink,
  浅灰蓝色: DesignTokens.colors.brand.slate,
  米色: colors.backgroundTertiary,
  奶油色: "colors.backgroundTertiary",
  深棕色: DesignTokens.colors.fashion.darkBrown,
  军绿色: DesignTokens.colors.fashion.armyGreen,
  纯黑色: DesignTokens.colors.neutral.black,
  冷灰色: "colors.textTertiary",
  深紫红色: DesignTokens.colors.fashion.deepMagenta,
  冰蓝色: DesignTokens.colors.fashion.iceBlue,
  橙色: "colors.warning",
  深黄色: "colors.warning",
  鲜艳的红色: "colors.error",
  暖棕色: colors.primaryDark,
  冷蓝色: DesignTokens.colors.fashion.cornflower,
  亮粉色: colors.primaryLight,
  荧光色: DesignTokens.colors.fashion.neon,
  深灰色: "colors.textSecondary",
  藏青色: DesignTokens.colors.fashion.navy,
};
...
function SeasonGradientBand({ season }: { season: string }) {
  const gradientColors = SEASON_GRADIENT[season] || [
