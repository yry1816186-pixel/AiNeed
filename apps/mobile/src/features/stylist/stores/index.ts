...
// Re-export ChatMessage type from types/chat for convenience
export type { ChatMessage } from "../../../types/chat";

// AI Stylist Chat Store - manages chat messages for AI stylist conversations
...
export const useAiStylistChatStore = create<AiStylistChatState>((set) => ({
  messages: [],
  isLoading: false,
  error: null,
