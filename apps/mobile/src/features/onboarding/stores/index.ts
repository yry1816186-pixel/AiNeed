...
export type OnboardingStep = "basicInfo" | "styleTest" | "photo" | "complete";
...
const onboardingInitialState = {
  currentStep: "basicInfo" as OnboardingStep,
...
export const useOnboardingStore = create<OnboardingState>((set) => ({
  ...
  submitOnboarding: async () => {
    ...
    try {
      ...
      set({ error: "Failed to submit onboarding data", isSubmitting: false });
    }
  },

  reset: () => set(onboardingInitialState),
}));
