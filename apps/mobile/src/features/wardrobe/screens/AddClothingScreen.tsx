...
export const AddClothingScreen: React.FC = () => {
  ...
  const handleSubmit = useCallback(async () => {
    if (!formData.category) {
      Alert.alert(t.common.confirm, t.wardrobe.addClothing);
      return;
    }
    ...
    try {
      ...
      if (response.success) {
        ...
        Alert.alert(t.common.done, t.wardrobe.addClothing, [
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>{t.wardrobe.addClothing}</Text>
        <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  imagePlaceholderHint: { fontSize: 12, color: theme.colors.textTertiary, marginTop: 4, opacity: 0.7 },
