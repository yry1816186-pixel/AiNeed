          ...
          <View style={styles.bloggerCard}>
            {product.blogger.avatar ? (
              ...
              <View style={styles.bloggerAvatarPlaceholder}>
                <Text style={styles.bloggerAvatarText}>
                  {product.blogger.nickname.charAt(0)}
                </Text>
              </View>
            )}
        ...
        <View style={styles.sheetOverlay}>
          ...
          <View style={styles.sheet}>
            ...
            <View style={styles.sheetProductInfo}>
              <Text style={styles.sheetProductName} numberOfLines={1}>{product.title}</Text>
              <Text style={styles.sheetProductPrice}>¥{product.price.toFixed(2)}</Text>
            </View>

            <Text style={styles.paymentLabel}>支付方式</Text>
            <TouchableOpacity
              style={[styles.paymentOption, selectedPayment === 'alipay' && styles.paymentOptionSelected]}
              onPress={() => setSelectedPayment('alipay')}
            >
              <View style={[styles.paymentRadio, selectedPayment === 'alipay' && styles.paymentRadioSelected]}>
            ...
            <TouchableOpacity
              style={[styles.paymentOption, selectedPayment === 'wechat' && styles.paymentOptionSelected]}
              onPress={() => setSelectedPayment('wechat')}
            >
              <View style={[styles.paymentRadio, selectedPayment === 'wechat' && styles.paymentRadioSelected]}>
            ...
            >
              {purchasing ? (
                ...
                <Text style={styles.confirmPurchaseBtnText}>确认支付 ¥{product.price.toFixed(2)}</Text>
              )}
            </TouchableOpacity>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  carouselSection: { backgroundColor: '#F5F5F5' },
  ...
  dotActive: { backgroundColor: '#6C5CE7', width: 8, height: 8, borderRadius: 4 },
  infoSection: {
    backgroundColor: theme.colors.surface,
    padding: 16,
    marginTop: 8,
  ...
  productPrice: { fontSize: 24, fontWeight: '700', color: '#6C5CE7', marginTop: 8 },
  originalPrice: {
    fontSize: 14,
  ...
  sheetProductPrice: { fontSize: 18, fontWeight: '700', color: '#6C5CE7' },
  ...
  paymentOptionSelected: { backgroundColor: '#F8F7FF' },
  paymentRadio: {
    width: 20,
    height: 20,
    borderRadius: 10,
  ...
  paymentRadioSelected: { borderColor: '#6C5CE7' },
  paymentRadioInner: { width: 10, height: 10, borderRadius: 5, backgroundColor: '#6C5CE7' },
