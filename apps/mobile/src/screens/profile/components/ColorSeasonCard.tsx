...
const COLOR_MAP: Record<string, string> = {
  '珊瑚色': '#FF7F7F', '桃色': '#FFB7B2', '杏色': '#FBCEB1', '暖黄色': '#FFD700',
  '草绿色': '#7CFC00', '天蓝色': '#87CEEB', '象牙白': '#FFFFF0',
  '粉色': '#FFC0CB', '薰衣草色': '#E6E6FA', '浅蓝色': '#ADD8E6',
  '玫瑰色': '#FF007F', '薄荷绿': '#98FB98', '淡紫色': '#DDA0DD', '雾蓝色': '#B0C4DE',
  '驼色': '#C19A6B', '棕色': '#8B4513', '橄榄绿': '#808000', '铁锈红': '#B7410E',
  '芥末黄': '#FFDB58', '南瓜色': '#FF7518', '酒红色': '#722F37',
  '正红色': '#FF0000', '纯白色': '#FFFFFF', '黑色': '#000000', '宝蓝色': '#4169E1',
  '翠绿色': '#50C878', '深紫色': '#301934', '玫红色': '#FF007F',
  '暖米色': '#F5F5DC', '棕褐色': '#D2B48C', '奶油白': '#FFFDD0',
  '柔和灰色': '#C0C0C0', '米白色': '#F5F5F5', '淡粉色': '#FFB6C1', '浅灰蓝色': '#B0C4DE',
  '米色': '#F5F5DC', '奶油色': '#FFFDD0', '深棕色': '#654321', '军绿色': '#4B5320',
  '纯黑色': '#000000', '冷灰色': '#A9A9A9', '深紫红色': '#4A0028', '冰蓝色': '#99FFFF',
  '橙色': '#FFA500', '深黄色': '#FFD700', '鲜艳的红色': '#FF0000', '暖棕色': '#8B4513',
  '冷蓝色': '#6495ED', '亮粉色': '#FF69B4', '荧光色': '#CCFF00',
  '深灰色': '#696969', '藏青色': '#000080',
};
      ...
      {!collapsed && (
        <View style={styles.cardContent}>
          ...
          <View style={styles.metalSection}>
            ...
            <Text style={styles.metalValue}>{METAL_LABELS[metalPreference] || metalPreference}</Text>
          </View>
        </View>
      )}
    </View>
