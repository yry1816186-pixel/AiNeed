...
export const consultantApi = {
  ...
  getProfileById: (id: string) => apiClient.get(`/consultant/profiles/${id}`),
  ...
  getBookingById: (id: string) => apiClient.get(`/consultant/bookings/${id}`),
  ...
  getCases: (consultantId: string) => apiClient.get(`/consultant/profiles/${consultantId}/cases`),
