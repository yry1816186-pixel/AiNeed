...
export const outfitApi = {
  ...
  async updateItemPosition(
    ...
    return apiClient.put<Outfit>(
      `/outfits/${outfitId}/items/${clothingId}/position`,
      position,
    );
  },
  ...
  async getRecommendations(params?: {
    ...
    return apiClient.post<OutfitRecommendationResult[]>(
  ...
  async getSimilar(
    id: string,
    limit: number = 5,
  ): Promise<ApiResponse<SimilarItemResult[]>> {
