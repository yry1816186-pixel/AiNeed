 ...
 */
export interface ImageWithPlaceholderProps extends Omit<FastImageProps, 'onLoad' | 'onError' | 'style'> {
  /** 图片源 */
...
export const AvatarImage = memo(function AvatarImage({ size = 48, style, ...props }: AvatarImageProps) {
  return (
    <ImageWithPlaceholder
      {...props}
      isCircular
