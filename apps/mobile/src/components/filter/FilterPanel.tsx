          ...
          <View style={styles.section}>
            ...
            <View style={styles.options}>
              <TouchableOpacity
                style={[
                  styles.option,
                  isFavorite === true && styles.optionSelected,
                ]}
                onPress={() =>
              ...
              >
                <Text
                  style={[
                    styles.optionText,
                    isFavorite === true && styles.optionTextSelected,
                  ]}
                >
                  已收藏
                </Text>
              ...
              <TouchableOpacity
                style={[
                  styles.option,
                  isFavorite === false && styles.optionSelected,
                ]}
                onPress={() =>
              ...
              >
                <Text
                  style={[
                    styles.optionText,
                    isFavorite === false && styles.optionTextSelected,
                  ]}
                >
                  未收藏
                </Text>
