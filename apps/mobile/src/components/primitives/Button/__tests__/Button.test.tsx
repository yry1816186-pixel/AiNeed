...
describe('Button', () => {
  ...
  it('does not call onPress when loading', () => {
    const onPress = jest.fn();
    const { getByText } = render(<Button loading onPress={onPress}>Loading</Button>);
    fireEvent.press(getByText('Loading').parent?.parent?.parent || getByText('Loading'));
  ...
  it('does not call onLongPress when disabled', () => {
    const onLongPress = jest.fn();
    const { getByText } = render(<Button disabled onLongPress={onLongPress}>Long Press</Button>);
    fireEvent(getByText('Long Press'), 'onLongPress');
