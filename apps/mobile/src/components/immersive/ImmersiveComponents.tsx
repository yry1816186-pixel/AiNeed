...
export const FullScreenGallery: React.FC<FullScreenGalleryProps> = ({
  ...
  const tapGesture = Gesture.Tap().onEnd(() => {
    controlsOpacity.value =
      controlsOpacity.value === 1 ? withTiming(0) : withTiming(1);
  ...
  const renderImage = ({
    ...
    <GestureDetector gesture={composedGesture}>
      <AnimatedView style={[styles.imageContainer, imageAnimatedStyle]}>
        ...
        {item.caption && (
          <AnimatedView
            style={[styles.captionContainer, controlsAnimatedStyle]}
          >
  ...
  return (
    ...
    >
      ...
      >
        <AnimatedPressable
          style={[styles.closeButton, controlsAnimatedStyle]}
          onPress={onClose}
        >
        ...
        {showCounter && (
          <AnimatedView
            style={[styles.counterContainer, controlsAnimatedStyle]}
          >
        ...
        {showThumbnails && images.length > 1 && (
          <AnimatedView
            style={[styles.thumbnailsContainer, controlsAnimatedStyle]}
          >
  ...
  return (
    ...
    >
      <AnimatedView style={[styles.immersiveContainer, containerAnimatedStyle]}>
        ...
        >
          <AnimatedView
            style={[styles.productImageContainer, imageAnimatedStyle]}
          >
            <Image
