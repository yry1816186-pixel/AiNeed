...
export const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  return (
    <AnimatedView
      style={[styles.emptyContainer, containerAnimatedStyle, style]}
    >
...
export const ErrorState: React.FC<ErrorStateProps> = ({
  ...
  return (
    <AnimatedView
      style={[styles.errorContainer, containerAnimatedStyle, style]}
    >
      {showIllustration && (
...
export const NetworkError: React.FC<NetworkErrorProps> = ({
  ...
  return (
    <AnimatedView
      style={[styles.networkContainer, containerAnimatedStyle, style]}
    >
...
export const MaintenanceScreen: React.FC<MaintenanceScreenProps> = ({
  ...
  return (
    <AnimatedView
      style={[styles.maintenanceContainer, containerAnimatedStyle, style]}
    >
      ...
      <View style={styles.maintenanceTips}>
        ...
        <Text style={styles.maintenanceTip}>
          • 关注我们的社交媒体获取最新动态
        </Text>
      </View>
    </AnimatedView>
...
export const PermissionDenied: React.FC<PermissionDeniedProps> = ({
  ...
  return (
    <AnimatedView
      style={[styles.permissionContainer, containerAnimatedStyle, style]}
    >
...
const ConfettiPiece: React.FC<ConfettiPieceProps> = ({ index }) => {
  ...
  useEffect(() => {
    ...
    confettiRotation.value = withRepeat(
      withTiming(360, { duration: rotationDuration }),
      -1,
      false,
    );
...
export const SuccessState: React.FC<SuccessStateProps> = ({
  ...
  return (
    <AnimatedView
      style={[styles.successContainer, containerAnimatedStyle, style]}
    >
