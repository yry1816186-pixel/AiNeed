...
const USERS = [
  ...
  },
  {
    ...
    password: "Test123456!",
    nickname: "demo_时尚达人小美",
    gender: "female" as Gender,
    birthDate: new Date("2000-05-08"),
...
export async function seedUsers(
  prisma: PrismaClient
): Promise<{ users: User[]; userMap: Map<string, User> }> {
  const users: User[] = [];
