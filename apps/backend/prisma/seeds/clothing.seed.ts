// @ts-nocheck
import { PrismaClient, ClothingCategory, Gender } from "@prisma/client";
...
const clothingData = [
  // ==================== tops: 8 件 ====================
  {
    ...
    name: "经典圆领纯棉T恤",
    description:
      "采用100%精梳棉面料，亲肤透气，圆领设计简约百搭，四季皆宜的基础款T恤。版型微宽松，适合各种身材。",
  ...
  },
  {
    ...
    name: "法式方领泡泡袖衬衫",
    description:
      "浪漫法式风格方领设计，展露锁骨线条，泡泡袖增添俏皮感。采用天丝棉混纺面料，垂坠感佳，优雅不失灵动。",
    category: ClothingCategory.tops,
    subcategory: "blouse",
    colors: ["奶白色", "淡蓝色", "樱花粉"],
    sizes: ["XS", "S", "M", "L"],
  ...
  },
  {
    ...
    name: "极简高领羊绒毛衣",
    description:
      "甄选内蒙古优质羊绒，细腻柔软不扎肤。高领设计保暖有型，修身剪裁勾勒身形，是秋冬衣橱的质感之选。",
    category: ClothingCategory.tops,
    subcategory: "sweater",
    colors: ["驼色", "黑色", "米白色"],
    sizes: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    name: "宽松落肩条纹长袖T恤",
    description:
      "经典条纹元素永不过时，落肩设计增添休闲感。宽松版型包容各种身材，棉质面料柔软舒适，日常穿搭轻松驾驭。",
    category: ClothingCategory.tops,
    subcategory: "tshirt",
    colors: ["蓝白条纹", "黑白条纹"],
    sizes: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    name: "丝质V领印花衬衫",
    description:
      "桑蚕丝面料自带高级光泽感，V领修饰脸型拉长颈部线条。抽象艺术印花独具品味，通勤约会皆可驾驭。",
    category: ClothingCategory.tops,
    subcategory: "blouse",
    colors: ["墨绿印花", "酒红印花"],
    sizes: ["XS", "S", "M", "L"],
  ...
  },
  {
    ...
    name: "Oversize连帽卫衣",
    description:
      "加厚毛圈面料内里抓绒，保暖性出色。Oversize版型潮流感十足，袋鼠口袋实用又时尚，秋冬街头必备单品。",
    category: ClothingCategory.tops,
    subcategory: "hoodie",
    colors: ["燕麦色", "深灰色", "黑色"],
    sizes: ["S", "M", "L", "XL", "XXL"],
  ...
  },
  {
    ...
    name: "复古盘扣立领棉麻衬衫",
    description:
      "中式立领搭配手工盘扣，东方韵味十足。棉麻混纺面料透气舒适，宽松版型自在随性，文艺气质满分。",
    category: ClothingCategory.tops,
    subcategory: "blouse",
    colors: ["月白色", "靛蓝色", "竹青色"],
    sizes: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    name: "一字领露肩针织上衣",
    description:
      "一字领设计展露优美肩线，弹力针织面料贴合身形。可拉至肩部做露肩穿法，也可拉高做船领，一衣两穿。",
    category: ClothingCategory.tops,
  ...
  // ==================== bottoms: 7 件 ====================
  {
    ...
    name: "高腰直筒牛仔裤",
    description:
      "经典高腰直筒版型，修饰腿型拉长比例。采用优质丹宁面料，微弹力设计穿着舒适，复古水洗色调百搭不挑人。",
  ...
  },
  {
    ...
    name: "垂坠感阔腿西装裤",
    description:
      "高腰阔腿版型气场全开，西装面料垂坠感极佳。裤腰褶皱设计增加层次感，九分长度露出脚踝显瘦显高。",
    category: ClothingCategory.bottoms,
  ...
  },
  {
    ...
    name: "百褶中长半裙",
    description:
      "细密百褶工艺，走动间裙摆飘逸灵动。中长款及膝长度优雅得体，高腰设计优化身材比例，通勤约会两相宜。",
    category: ClothingCategory.bottoms,
    subcategory: "skirt",
    colors: ["黑色", "香槟色", "墨绿色"],
    sizes: ["XS", "S", "M", "L"],
  ...
  },
  {
    ...
    name: "工装风束脚裤",
    description:
      "多口袋设计实用又帅气，束脚抽绳可调节裤型。军绿色调复古硬朗，宽松版型舒适自在，街头潮流必备。",
    category: ClothingCategory.bottoms,
    subcategory: "cargo",
    colors: ["军绿色", "卡其色", "黑色"],
    sizes: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    name: "弹力修身小脚裤",
    description:
      "高弹力面料完美贴合腿部线条，修身不紧绷。小脚设计利落显瘦，搭配各种鞋型都好看，日常穿搭万能裤。",
    category: ClothingCategory.bottoms,
  ...
  },
  {
    ...
    name: "A字牛仔半裙",
    description:
      "经典A字版型修饰臀腿线条，前排扣设计增添复古韵味。中长长度端庄大方，后开叉行走自如，春夏百搭单品。",
    category: ClothingCategory.bottoms,
    subcategory: "skirt",
    colors: ["浅蓝色", "深蓝色"],
    sizes: ["XS", "S", "M", "L"],
  ...
  },
  {
    ...
    name: "羊毛混纺宽腰头西裤",
    description:
      "含羊毛成分面料质感上乘，宽腰头设计舒适不勒。微锥形裤腿修饰腿型，裤脚微开叉细节考究，商务场合首选。",
    category: ClothingCategory.bottoms,
    subcategory: "trousers",
    colors: ["藏青色", "炭灰色", "黑色"],
    sizes: ["S", "M", "L", "XL"],
  ...
  // ==================== dresses: 6 件 ====================
  {
    ...
    name: "小黑裙经典款",
    description:
      "永恒经典的小黑裙，收腰A字版型修饰身材。及膝长度端庄优雅，方领设计展露锁骨，从晚宴到约会一裙搞定。",
  ...
  },
  {
    ...
    name: "碎花雪纺连衣裙",
    description:
      "轻盈雪纺面料随风飘逸，小碎花图案清新浪漫。V领设计拉长颈部线条，收腰系带勾勒腰身，春夏约会首选。",
    category: ClothingCategory.dresses,
    subcategory: "floral",
  ...
  },
  {
    ...
    name: "极简针织连衣裙",
    description:
      "极简主义设计，一体式剪裁利落大方。弹力针织面料贴合身形，中长袖设计四季可穿，单穿或叠搭皆出彩。",
    category: ClothingCategory.dresses,
    subcategory: "knit",
    colors: ["驼色", "黑色", "灰色"],
    sizes: ["XS", "S", "M", "L"],
  ...
  },
  {
    ...
    name: "丝绒吊带长裙",
    description:
      "奢华丝绒面料自带光泽质感，细吊带设计性感优雅。高腰线分割优化比例，长至脚踝气场全开，派对晚宴焦点之选。",
    category: ClothingCategory.dresses,
    subcategory: "evening",
    colors: ["酒红色", "墨绿色", "黑色"],
    sizes: ["XS", "S", "M", "L"],
  ...
  },
  {
    ...
    name: "衬衫式连衣裙",
    description:
      "衬衫裙版型利落有型，系带收腰设计勾勒曲线。翻领+前开扣经典不过时，中长长度通勤休闲两不误。",
    category: ClothingCategory.dresses,
  ...
  },
  {
    ...
    name: "复古方领泡泡袖连衣裙",
    description:
      "复古方领搭配泡泡袖，宫廷风优雅。收腰大摆裙设计，行走间裙摆摇曳生姿。后背隐形拉链，穿脱方便。",
    category: ClothingCategory.dresses,
    subcategory: "retro",
    colors: ["复古红", "墨绿色", "藏青色"],
    sizes: ["XS", "S", "M", "L"],
  ...
  // ==================== outerwear: 7 件 ====================
  {
    ...
    name: "经典双排扣风衣",
    description:
      "英伦经典双排扣设计，肩章与袖袢细节考究。中长款防风防雨面料，春秋换季必备，职场休闲通吃。",
  ...
  },
  {
    ...
    name: "极简廓形羊毛大衣",
    description:
      "宽松廓形设计，不挑身材气场十足。双面羊毛工艺轻盈保暖，无扣开放式穿着洒脱随性，极简主义风格典范。",
    category: ClothingCategory.outerwear,
  ...
  },
  {
    ...
    name: "短款机车皮衣",
    description:
      "经典机车款皮衣，不对称拉链设计酷感十足。绵羊皮面料柔软有型，短款版型提升腰线，搭配裙装裤装都出彩。",
    category: ClothingCategory.outerwear,
  ...
  },
  {
    ...
    name: "轻量羽绒服",
    description:
      "90%白鸭绒填充，轻盈保暖不臃肿。立领设计防风保暖，可收纳便携设计出行无忧，秋冬通勤好搭档。",
    category: ClothingCategory.outerwear,
    subcategory: "puffer",
    colors: ["黑色", "深蓝色", "酒红色"],
    sizes: ["S", "M", "L", "XL", "XXL"],
  ...
  },
  {
    ...
    name: "针织开衫",
    description:
      "粗针编织纹理感丰富，落肩设计休闲舒适。前开扣穿脱方便，可做外套可做内搭，春秋换季实用单品。",
    category: ClothingCategory.outerwear,
  ...
  },
  {
    ...
    name: "西装外套",
    description:
      "修身剪裁西装外套，垫肩设计撑起气场。微收腰版型不显臃肿，内衬丝滑穿脱方便，职场穿搭利器。",
    category: ClothingCategory.outerwear,
    subcategory: "blazer",
    colors: ["黑色", "深灰色", "驼色"],
    sizes: ["XS", "S", "M", "L"],
  ...
  },
  {
    ...
    name: "连帽中长棉服",
    description:
      "中长款设计保暖覆盖面积大，连帽可拆卸灵活多变。填充仿丝棉轻盈保暖，多个口袋实用方便，冬日出行首选。",
    category: ClothingCategory.outerwear,
  ...
  // ==================== footwear: 6 件 ====================
  {
    ...
    name: "经典白色运动鞋",
    description:
      "简约白色鞋身搭配厚底设计，增高显瘦。透气网面+皮革拼接，脚感轻盈舒适，百搭各种风格。",
  ...
  },
  {
    ...
    name: "尖头细高跟鞋",
    description:
      "经典尖头细跟设计，8cm跟高拉长腿部线条。优质漆皮面料光泽感佳，通勤约会提升气场的秘密武器。",
    category: ClothingCategory.footwear,
    subcategory: "heels",
    colors: ["黑色", "裸色", "红色"],
  ...
  },
  {
    ...
    name: "乐福鞋",
    description:
      "经典乐福鞋型，方头设计舒适不挤脚。软底软面走路不累，金属扣装饰增添精致感，通勤休闲两相宜。",
    category: ClothingCategory.footwear,
    subcategory: "loafers",
    colors: ["黑色", "棕色", "酒红色"],
    sizes: ["36", "37", "38", "39", "40", "41"],
  ...
  },
  {
    ...
    name: "Air Max 气垫跑鞋",
    description:
      "可视气垫缓震科技，跑步或日常穿着都舒适。网面鞋身透气轻盈，流线型设计动感十足，运动潮流两不误。",
    category: ClothingCategory.footwear,
    subcategory: "running",
    colors: ["黑白", "灰蓝", "纯黑"],
  ...
  },
  {
    ...
    name: "穆勒拖鞋",
    description:
      "半包脚设计穿脱方便，方头舒适不挤脚。软底缓震走路不累，简约设计搭配各种风格，春夏必备懒人鞋。",
    category: ClothingCategory.footwear,
    subcategory: "mules",
    colors: ["黑色", "米白色", "焦糖色"],
    sizes: ["36", "37", "38", "39", "40"],
  ...
  // ==================== accessories: 8 件 ====================
  {
    ...
    name: "极简金属表带手表",
    description:
      "简约圆形表盘搭配金属表带，日本机芯走时精准。30米生活防水，日常佩戴无忧，职场休闲皆可搭配。",
  ...
  },
  {
    ...
    name: "丝巾",
    description:
      "100%桑蚕丝面料，手感丝滑光泽柔美。多种系法变化，可做头巾、领巾、包饰，一条丝巾多种搭配。",
    category: ClothingCategory.accessories,
    subcategory: "scarf",
    colors: ["印花蓝", "印花红", "印花绿"],
    sizes: ["均码"],
  ...
  },
  {
    ...
    name: "珍珠耳环",
    description:
      "天然淡水珍珠搭配925银针，温润光泽衬托气质。简约设计不挑脸型，日常佩戴或出席场合皆适宜。",
    category: ClothingCategory.accessories,
  ...
  },
  {
    ...
    name: "链条斜挎包",
    description:
      "经典翻盖链条包设计，皮质细腻手感柔软。金属链条肩带可调节，容量适中满足日常需求，约会通勤百搭包款。",
    category: ClothingCategory.accessories,
    subcategory: "bag",
    colors: ["黑色", "米白色", "酒红色"],
    sizes: ["均码"],
  ...
  },
  {
    ...
    name: "宽檐礼帽",
    description:
      "经典宽檐设计修饰脸型，羊毛呢面料挺括有型。可折叠便携设计，度假出游拍照利器，秋冬搭配提升品味。",
    category: ClothingCategory.accessories,
    subcategory: "hat",
    colors: ["黑色", "驼色", "灰色"],
    sizes: ["M", "L"],
  ...
  },
  {
    ...
    name: "墨镜",
    description:
      "大框猫眼设计修饰脸型，UV400防晒保护双眼。轻量材质佩戴舒适不压鼻梁，夏日出行必备时尚单品。",
    category: ClothingCategory.accessories,
  ...
  },
  {
    ...
    name: "编织托特包",
    description:
      "手工编织设计质感独特，大容量满足通勤需求。内含隔层收纳有序，皮质手柄舒适耐用，工作休闲两不误。",
    category: ClothingCategory.accessories,
    subcategory: "bag",
    colors: ["自然色", "黑色", "棕色"],
    sizes: ["均码"],
  ...
  // ==================== activewear: 5 件 ====================
  {
    ...
    name: "高弹力瑜伽裤",
    description:
      "四向弹力面料自由伸展无束缚，高腰设计包裹腹部不卷边。吸湿速干科技保持干爽，瑜伽健身日常皆宜。",
  ...
  },
  {
    ...
    name: "运动背心",
    description:
      "中强度支撑适合瑜伽和训练，宽肩带设计减少肩部压力。内置可拆卸胸垫方便清洗，透气网眼拼接散热快。",
    category: ClothingCategory.activewear,
  ...
  },
  {
    ...
    name: "速干T恤",
    description:
      "Dri-FIT速干科技面料快速排汗，保持运动干爽。宽松版型活动自如，反光Logo设计夜跑更安全。",
    category: ClothingCategory.activewear,
    subcategory: "tshirt",
    colors: ["黑色", "白色", "荧光绿"],
    sizes: ["S", "M", "L", "XL", "XXL"],
  ...
  },
  {
    ...
    name: "运动短裤",
    description:
      "轻量面料无负重感，内衬设计防走光。侧边开叉增加活动范围，隐形口袋可放钥匙卡片，夏日运动首选。",
    category: ClothingCategory.activewear,
    subcategory: "shorts",
    colors: ["黑色", "深灰色", "藏青色"],
    sizes: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    name: "拉链运动外套",
    description:
      "全拉链设计穿脱方便，立领防风保暖。拇指孔设计袖口不滑落，侧边口袋可存放物品，运动前后保暖必备。",
    category: ClothingCategory.activewear,
    subcategory: "jacket",
    colors: ["黑色", "深灰色", "酒红色"],
    sizes: ["S", "M", "L", "XL"],
  ...
  // ==================== swimwear: 3 件 ====================
  {
    ...
    name: "连体泳衣",
    description:
      "经典连体设计修饰身材，交叉V领展露锁骨线条。聚拢效果自信穿着，内衬设计舒适不透，海边度假必备。",
  ...
  },
  {
    ...
    name: "比基尼套装",
    description:
      "三角杯上衣搭配系带比基尼底，性感俏皮。可调节肩带和系带设计贴合身形，度假拍照上镜之选。",
    category: ClothingCategory.swimwear,
    subcategory: "bikini",
    colors: ["白色", "黑色", "热带印花"],
    sizes: ["S", "M", "L"],
  ...
  },
  {
    ...
    name: "挂脖分体泳衣",
    description:
      "挂脖设计展露肩背线条，高腰底裤修饰腹部。运动与时尚兼顾，泳池游泳或海边嬉戏都适合。",
    category: ClothingCategory.swimwear,
    subcategory: "tankini",
    colors: ["墨绿色", "珊瑚色", "黑色"],
    sizes: ["S", "M", "L", "XL"],
    ...
    attributes: {
      ...
      careInstructions:
        "手洗冷水，使用中性洗涤剂，不可漂白，不可拧干，阴凉处晾干，避免接触粗糙表面",
    },
  },
];
...
const categoryTemplates = {
  tops: {
    ...
    descTemplates: [
      (n, m) =>
        `${n}，采用优质${m}面料，穿着舒适透气。版型考究，适合日常穿搭与通勤场合，百搭实用不挑人。`,
      (n, m) =>
        `${n}，${m}面料质感上乘，设计独特展现个性风格。柔软亲肤，修饰身材，是衣橱必备的时尚单品。`,
      (n, m) =>
        `${n}，精选${m}面料，手感细腻垂坠感佳。简约设计蕴含精致细节，轻松驾驭各种场合与风格。`,
      (n, m) =>
        `${n}，甄选高品质${m}材质，经久耐穿不易变形。经典款式融入当季流行元素，搭配灵活随心切换。`,
    ],
    materials: [
      "纯棉",
      "天丝棉",
  ...
  outerwear: {
    ...
    descTemplates: [
      (n, m) =>
        `${n}，${m}面料挺括有型，剪裁利落大气。保暖性与时尚感兼具，秋冬衣橱不可或缺的单品。`,
  ...
  activewear: {
    ...
    descTemplates: [
      ...
      (n, m) =>
        `${n}，精选高弹${m}面料，四面弹力自由伸展。专业级工艺打造，健身房与户外运动皆可胜任。`,
    ],
    materials: [
      "速干涤纶",
      "弹力锦纶",
  ...
  swimwear: {
    ...
    descTemplates: [
      ...
      (n, m) =>
        `${n}，精选优质${m}面料，轻薄速干穿着舒适。时尚设计搭配精致工艺，海边度假吸睛之选。`,
    ],
    materials: [
      "氨纶混纺",
      "锦纶",
...
const sizeChartGenerators = {
  tops: (sizeSet: string[]) =>
    sizeSet.map((s) => {
      const base = {
        S: { bust: 92, shoulder: 42, length: 64 },
        M: { bust: 96, shoulder: 44, length: 66 },
        L: { bust: 100, shoulder: 46, length: 68 },
        XL: { bust: 104, shoulder: 48, length: 70 },
        XXL: { bust: 108, shoulder: 50, length: 72 },
        XS: { bust: 88, shoulder: 40, length: 62 },
      }[s] || { bust: 96, shoulder: 44, length: 66 };
      return {
        size: s,
        bust: String(base.bust + Math.floor(Math.random() * 8)),
        shoulder: String(base.shoulder + Math.floor(Math.random() * 4)),
        length: String(base.length + Math.floor(Math.random() * 4)),
      };
    }),
  bottoms: (sizeSet: string[]) =>
    sizeSet.map((s) => {
      const base = {
        S: { waist: 66, hip: 90, inseam: 76 },
        M: { waist: 70, hip: 94, inseam: 78 },
        L: { waist: 74, hip: 98, inseam: 80 },
        XL: { waist: 78, hip: 102, inseam: 82 },
        XXL: { waist: 82, hip: 106, inseam: 84 },
        XS: { waist: 62, hip: 86, inseam: 74 },
      }[s] || { waist: 70, hip: 94, inseam: 78 };
      return {
        size: s,
        waist: String(base.waist + Math.floor(Math.random() * 4)),
        hip: String(base.hip + Math.floor(Math.random() * 4)),
        inseam: String(base.inseam + Math.floor(Math.random() * 3)),
      };
    }),
  dresses: (sizeSet: string[]) =>
    sizeSet.map((s) => {
      const base = {
        S: { bust: 84, waist: 66, hip: 90, length: 100 },
        M: { bust: 88, waist: 70, hip: 94, length: 102 },
        L: { bust: 92, waist: 74, hip: 98, length: 104 },
        XL: { bust: 96, waist: 78, hip: 102, length: 106 },
        XS: { bust: 80, waist: 62, hip: 86, length: 98 },
      }[s] || { bust: 88, waist: 70, hip: 94, length: 102 };
      return {
        size: s,
        bust: String(base.bust + Math.floor(Math.random() * 4)),
        waist: String(base.waist + Math.floor(Math.random() * 4)),
        hip: String(base.hip + Math.floor(Math.random() * 4)),
        length: String(base.length + Math.floor(Math.random() * 6)),
      };
    }),
  outerwear: (sizeSet: string[]) =>
    sizeSet.map((s) => {
      const base = {
        S: { bust: 96, shoulder: 42, sleeve: 58, length: 100 },
        M: { bust: 100, shoulder: 44, sleeve: 60, length: 102 },
        L: { bust: 104, shoulder: 46, sleeve: 62, length: 104 },
        XL: { bust: 108, shoulder: 48, sleeve: 64, length: 106 },
        XXL: { bust: 112, shoulder: 50, sleeve: 66, length: 108 },
      }[s] || { bust: 100, shoulder: 44, sleeve: 60, length: 102 };
      return {
        size: s,
        bust: String(base.bust + Math.floor(Math.random() * 8)),
        shoulder: String(base.shoulder + Math.floor(Math.random() * 4)),
        sleeve: String(base.sleeve + Math.floor(Math.random() * 3)),
        length: String(base.length + Math.floor(Math.random() * 6)),
      };
    }),
  footwear: (sizeSet: string[]) =>
    sizeSet.map((s) => ({ size: s, footLength: String(Number(s) * 5 + 115) })),
  accessories: (_sizeSet: string[]) => [],
  activewear: (sizeSet: string[]) =>
    sizeSet.map((s) => {
      const base = {
        S: { bust: 84, waist: 64, hip: 88 },
        M: { bust: 88, waist: 68, hip: 92 },
        L: { bust: 92, waist: 72, hip: 96 },
        XL: { bust: 96, waist: 76, hip: 100 },
        XXL: { bust: 100, waist: 80, hip: 104 },
        XS: { bust: 80, waist: 60, hip: 84 },
  ...
  swimwear: (sizeSet: string[]) =>
    sizeSet.map((s) => {
      const base = {
        S: { bust: 82, waist: 64, hip: 88 },
        M: { bust: 86, waist: 68, hip: 92 },
        L: { bust: 90, waist: 72, hip: 96 },
        XL: { bust: 94, waist: 76, hip: 100 },
        XS: { bust: 78, waist: 60, hip: 84 },
      }[s] || { bust: 86, waist: 68, hip: 92 };
      return {
        size: s,
        bust: String(base.bust + Math.floor(Math.random() * 4)),
        waist: String(base.waist + Math.floor(Math.random() * 4)),
...
for (const [cat, target] of Object.entries(categoryCounts)) {
  const existingCount = clothingData.filter(
    (item) => item.category === ClothingCategory[cat]
  ).length;
  ...
  for (let i = 0; i < needed; i++) {
    ...
    const originalPrice = hasDiscount
      ? Math.round((price * (1.2 + seededRandom() * 0.5)) / 10) * 10
      : null;
    ...
    clothingData.push({
      sku: `AN-${categoryAbbrevs[cat as keyof typeof categoryAbbrevs]}-${String(skuNum).padStart(
        3,
        "0"
      )}`,
      name: fullName,
...
// ============================================================================
// Enrich items with material/season/gender/source top-level fields
// ============================================================================
...
const subcategoryGenderMap: Record<string, Gender> = {
  tshirt: Gender.unisex,
  blouse: Gender.female,
  sweater: Gender.unisex,
  hoodie: Gender.unisex,
  knitwear: Gender.female,
  polo: Gender.unisex,
  tank_top: Gender.female,
  crop_top: Gender.female,
  jeans: Gender.unisex,
  trousers: Gender.unisex,
  skirt: Gender.female,
  cargo: Gender.unisex,
  leggings: Gender.female,
  shorts: Gender.unisex,
  cocktail: Gender.female,
  floral: Gender.female,
  knit: Gender.female,
  evening: Gender.female,
  shirt_dress: Gender.female,
  retro: Gender.female,
  mini: Gender.female,
  midi: Gender.female,
  maxi: Gender.female,
  wrap_dress: Gender.female,
  slip_dress: Gender.female,
  trench_coat: Gender.unisex,
  wool_coat: Gender.unisex,
  leather_jacket: Gender.unisex,
  puffer: Gender.unisex,
  cardigan: Gender.unisex,
  blazer: Gender.unisex,
  padded_coat: Gender.unisex,
  jacket: Gender.unisex,
  coat: Gender.unisex,
  windbreaker: Gender.unisex,
  down_jacket: Gender.unisex,
  trench: Gender.unisex,
  bomber: Gender.unisex,
  sneakers: Gender.unisex,
  heels: Gender.female,
  loafers: Gender.unisex,
  boots: Gender.unisex,
  running: Gender.unisex,
  mules: Gender.female,
  flats: Gender.female,
  sandals: Gender.female,
  bag: Gender.female,
  scarf: Gender.unisex,
  ...
  watch: Gender.unisex,
  jewelry: Gender.female,
  sports_bra: Gender.female,
  sports_top: Gender.unisex,
  tracksuit: Gender.unisex,
  running_shorts: Gender.unisex,
  one_piece: Gender.female,
  bikini: Gender.female,
  tankini: Gender.female,
  swim_trunks: Gender.male,
  rash_guard: Gender.unisex,
  pants: Gender.unisex,
  wide_leg: Gender.female,
  culottes: Gender.female,
  jogger: Gender.unisex,
};
...
for (const item of clothingData) {
  const catKey =
    Object.keys(ClothingCategory).find((k) => ClothingCategory[k] === item.category) || "tops";

  if (!item.material) {
    const attrMat = item.attributes?.material;
    if (typeof attrMat === "string") {
      item.material = attrMat.split("，")[0].split(",")[0];
    } else {
      const template = categoryTemplates[catKey as keyof typeof categoryTemplates];
      const matIdx = clothingData.indexOf(item) % template.materials.length;
      item.material = template.materials[matIdx];
    }
  }

  if (!item.season) {
    const seasons = categorySeasonMap[catKey] || ["all_season"];
    item.season = seasons[clothingData.indexOf(item) % seasons.length];
  }

  if (!item.gender) {
    item.gender = subcategoryGenderMap[item.subcategory] || Gender.unisex;
  }
...
export async function seedClothing(
  ...
  for (const data of clothingData) {
    ...
    if (existing) {
      if (!existing.material || !existing.season || !existing.gender) {
