...
export const QUESTION_IMAGE_META_MAP: Record<string, QuizImageMeta[]> = {
  "q-occasion-01": [
    {
      index: 0,
      dominantColors: [{ h: 220, s: 60, l: 45 }],
    ...
    {
      index: 1,
      dominantColors: [{ h: 340, s: 55, l: 50 }],
      styleTags: ["elegant", "evening"],
      occasion: "date",
      priceRange: "premium",
    ...
    {
      index: 2,
      dominantColors: [{ h: 120, s: 40, l: 55 }],
    ...
    {
      index: 4,
      dominantColors: [{ h: 270, s: 45, l: 40 }],
      styleTags: ["creative", "arty"],
      occasion: "social",
      priceRange: "mid_range",
      applicableGenders: ["female"],
    },
  ...
  "q-occasion-02": [
    ...
    {
      index: 1,
      dominantColors: [{ h: 200, s: 50, l: 70 }],
      styleTags: ["preppy", "clean"],
      occasion: "date",
      priceRange: "mid_range",
      applicableGenders: ["male"],
    },
    {
      index: 2,
      dominantColors: [{ h: 45, s: 80, l: 55 }],
      styleTags: ["bohemian", "free"],
      occasion: "vacation",
      priceRange: "budget",
      applicableGenders: ["female"],
    },
    {
      index: 3,
      dominantColors: [{ h: 180, s: 30, l: 50 }],
    ...
    {
      index: 4,
      dominantColors: [{ h: 350, s: 65, l: 45 }],
      styleTags: ["glamorous", "evening"],
      occasion: "party",
      priceRange: "premium",
      applicableGenders: ["female"],
    },
    {
      index: 5,
      dominantColors: [{ h: 150, s: 35, l: 60 }],
      styleTags: ["relaxed", "cozy"],
      occasion: "home",
      priceRange: "budget",
      applicableGenders: ["male", "female"],
    },
  ...
  "q-color-01": [
    {
      index: 0,
      dominantColors: [{ h: 0, s: 85, l: 50 }],
      styleTags: ["bold", "energetic"],
      occasion: "social",
      priceRange: "mid_range",
      applicableGenders: ["female"],
    },
    {
      index: 1,
      dominantColors: [{ h: 210, s: 70, l: 55 }],
    ...
    {
      index: 2,
      dominantColors: [{ h: 50, s: 75, l: 60 }],
      styleTags: ["cheerful", "warm"],
      occasion: "weekend",
      priceRange: "budget",
      applicableGenders: ["female"],
    },
    {
      index: 3,
      dominantColors: [{ h: 150, s: 50, l: 45 }],
    ...
    {
      index: 4,
      dominantColors: [{ h: 280, s: 60, l: 50 }],
      styleTags: ["mysterious", "elegant"],
      occasion: "date",
      priceRange: "premium",
      applicableGenders: ["female"],
    },
  ...
  "q-color-02": [
    ...
    {
      index: 1,
      dominantColors: [{ h: 0, s: 0, l: 100 }],
      styleTags: ["pure", "minimal"],
      occasion: "date",
      priceRange: "premium",
      applicableGenders: ["female"],
    },
    {
      index: 2,
      dominantColors: [{ h: 15, s: 80, l: 55 }],
      styleTags: ["earthy", "autumn"],
      occasion: "weekend",
      priceRange: "mid_range",
      applicableGenders: ["male", "female"],
    },
    {
      index: 3,
      dominantColors: [{ h: 190, s: 65, l: 50 }],
      styleTags: ["cool", "modern"],
      occasion: "social",
      priceRange: "mid_range",
      applicableGenders: ["male"],
    },
    {
      index: 4,
      dominantColors: [{ h: 330, s: 70, l: 65 }],
  ...
  "q-style-01": [
    ...
    {
      index: 2,
      dominantColors: [{ h: 200, s: 40, l: 60 }],
    ...
    {
      index: 3,
      dominantColors: [{ h: 300, s: 55, l: 45 }],
    ...
    {
      index: 4,
      dominantColors: [{ h: 160, s: 45, l: 55 }],
    ...
    {
      index: 5,
      dominantColors: [{ h: 240, s: 50, l: 35 }],
      styleTags: ["avant-garde", "experimental"],
      occasion: "party",
      priceRange: "luxury",
      applicableGenders: ["male", "female"],
    },
  ...
  "q-style-02": [
    ...
    {
      index: 3,
      dominantColors: [{ h: 175, s: 40, l: 70 }],
      styleTags: ["scandinavian", "simple"],
      occasion: "home",
      priceRange: "premium",
      applicableGenders: ["male", "female"],
    },
    {
      index: 4,
      dominantColors: [{ h: 55, s: 70, l: 55 }],
      styleTags: ["country", "rustic"],
      occasion: "outdoor",
      priceRange: "budget",
      applicableGenders: ["female"],
    },
  ...
  "q-price-01": [
    ...
    {
      index: 1,
      dominantColors: [{ h: 210, s: 55, l: 50 }],
      styleTags: ["quality", "versatile"],
      occasion: "workplace",
      priceRange: "mid_range",
      applicableGenders: ["male", "female"],
    },
    ...
    {
      index: 3,
      dominantColors: [{ h: 40, s: 90, l: 50 }],
      styleTags: ["luxury", "exclusive"],
      occasion: "party",
      priceRange: "luxury",
      applicableGenders: ["female"],
    },
    {
      index: 4,
      dominantColors: [{ h: 0, s: 0, l: 20 }],
      styleTags: ["investment", "timeless"],
      occasion: "workplace",
      priceRange: "luxury",
      applicableGenders: ["male"],
    },
  ...
  "q-price-02": [
    {
      index: 0,
      dominantColors: [{ h: 120, s: 50, l: 60 }],
      styleTags: ["value", "practical"],
      occasion: "home",
      priceRange: "budget",
      applicableGenders: ["male", "female"],
    },
    {
      index: 1,
      dominantColors: [{ h: 240, s: 35, l: 55 }],
      styleTags: ["balanced", "smart"],
      occasion: "workplace",
      priceRange: "mid_range",
      applicableGenders: ["male"],
    },
    {
      index: 2,
      dominantColors: [{ h: 330, s: 60, l: 55 }],
      styleTags: ["aspirational", "elegant"],
      occasion: "date",
      priceRange: "premium",
      applicableGenders: ["female"],
    },
    {
      index: 3,
      dominantColors: [{ h: 50, s: 85, l: 45 }],
      styleTags: ["statement", "bold"],
      occasion: "social",
      priceRange: "premium",
      applicableGenders: ["male", "female"],
    },
    {
      index: 4,
      dominantColors: [{ h: 0, s: 0, l: 5 }],
      styleTags: ["bespoke", "haute-couture"],
      occasion: "party",
      priceRange: "luxury",
      applicableGenders: ["female"],
    },
    {
      index: 5,
      dominantColors: [{ h: 180, s: 25, l: 65 }],
      styleTags: ["sustainable", "conscious"],
      occasion: "weekend",
      priceRange: "mid_range",
      applicableGenders: ["male", "female"],
    },
...
export class QuestionSelectorService {
  ...
  async selectQuestions(userId: string, quizId: string): Promise<QuizQuestionWithMeta[]> {
    ...
    const questionsWithMeta: QuizQuestionWithMeta[] = allQuestions.map(
      (q: {
        id: string;
        quizId: string;
        content: string;
    ...
    const candidateRemaining =
      genderFilteredRemaining.length > 0 ? genderFilteredRemaining : remaining;
