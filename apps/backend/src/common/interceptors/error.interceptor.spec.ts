...
function createMockCallHandler(error: unknown) {
...
describe("ErrorInterceptor", () => {
  ...
  describe("ValidationException", () => {
    ...
    it("should include constraint in meta in non-production", (done) => {
      ...
      interceptor.intercept(createMockContext(), createMockCallHandler(exception)).subscribe({
        error: (err) => {
          const body = err.getResponse();
  ...
  describe("Prisma errors", () => {
    it("should map P2002 to 409 Conflict", (done) => {
      const exception = new PrismaClientKnownRequestError("Unique constraint failed", {
        ...
        clientVersion: "5.0.0",
        meta: { target: ["email"] },
      } as unknown as ConstructorParameters<typeof PrismaClientKnownRequestError>[1]);
    ...
    it("should map P2011 to 422 Unprocessable Entity", (done) => {
      const exception = new PrismaClientKnownRequestError("Null constraint violation", {
        code: "P2011",
        clientVersion: "5.0.0",
      } as unknown as ConstructorParameters<typeof PrismaClientKnownRequestError>[1]);
  ...
  describe("Production mode", () => {
    ...
    it("should sanitize Prisma error messages", (done) => {
      const exception = new PrismaClientKnownRequestError("Raw database error message", {
        code: "P2002",
        clientVersion: "5.0.0",
      } as unknown as ConstructorParameters<typeof PrismaClientKnownRequestError>[1]);
