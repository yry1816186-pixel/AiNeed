...
export class NotFoundException extends HttpException {
   ...
   */
  constructor(resourceType: string | ResourceType, resourceId: string, message?: string) {
  ...
  static recommendation(recommendationId: string): NotFoundException {
    return new NotFoundException(ResourceType.RECOMMENDATION, recommendationId, "推荐不存在");
  }
  ...
  static subscription(subscriptionId: string): NotFoundException {
    return new NotFoundException(ResourceType.SUBSCRIPTION, subscriptionId, "订阅不存在");
  }
  ...
  static notification(notificationId: string): NotFoundException {
    return new NotFoundException(ResourceType.NOTIFICATION, notificationId, "通知不存在");
  }
