...
export class AiQuotaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    const quotaType = this.reflector.getAllAndOverride<QuotaTypeEnum>(QUOTA_TYPE_KEY, [
      context.getHandler(),
      context.getClass(),
    ]);
